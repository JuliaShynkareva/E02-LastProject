      ...
      <div id="content">
          <div id="applicationView">
              ...
              <c:if test="${application.employeeId ne null}">
                  ...
                  <c:if test="${isThatEmpl == 1}">
                      <c:if test="${application.statusId.id == 2}">
                          <form action="/employee/Web/viewapp/editapp" method="post">
              ...
              <c:if test="${empty application.employeeId}">
                  <form action="/employee/Web/viewapp/editempl" method="get">
          ...
          <a href="/employee/Web">Вернуться к списку заявок</a>
      </div>
  </body>
</html>
