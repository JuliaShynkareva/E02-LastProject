      ...
      <div id="content">
          <div id="applicationView">
              ...
              <c:if test="${application.employeeId ne null}">
                  ...
                  <c:if test="${isThatEmpl == 1}">
                      <c:if test="${application.statusId.id == 2}">
                          <form action="/employee/Sys/viewapp/editapp" method="post">
              ...
              <c:if test="${empty application.employeeId}">
                  <form action="/employee/Sys/viewapp/editempl" method="get">
          ...
          <a href="/employee/Sys">Вернуться к списку заявок</a>
      </div>
  </body>
</html>
